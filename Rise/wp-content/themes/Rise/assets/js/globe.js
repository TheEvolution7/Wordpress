...
var props = {
  ...
  colours: {
    // Cache the colours
    globeDots: 'rgba(0,0,0,0.2)', // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
...
function addGlobe() {
  ...
  canvasGradient.addColorStop(1, 'rgba(0, 0, 0,0.01)');
  canvasGradient.addColorStop(1, 'rgba(0, 0, 0,0.01)');
  canvasGradient.addColorStop(1, 'rgba(0, 0, 0,0.01)');

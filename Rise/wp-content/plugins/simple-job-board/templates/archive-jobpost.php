...
<div class="content-wrapper">
    ...
    <div class="services __career section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 animate-box fadeInUp" data-animate-effect="fadeInUp">
                    <h2 class="section-title"><?php echo apply_filters('sjb_jobs_archive_title', esc_html__('Career Board', 'simple-job-board')); ?></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12">

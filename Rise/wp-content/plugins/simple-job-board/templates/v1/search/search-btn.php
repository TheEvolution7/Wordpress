...
{
    // Search Button 
    $search_button = '<div class="sjb-search-button ' . apply_filters('sjb_filters_button_class', 'col-md-3 col-xs-12') . '">'
        . '<button type="submit" class="butn-dark mb-30"><span style="color:#fff"><i class="ti-search"></i></span></button>'
        . '</div>';

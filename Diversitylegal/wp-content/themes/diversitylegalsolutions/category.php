...
$section_2 = get_field('section_2',15);
$section_3 = get_field('section_3',15);
$section_4 = get_field('section_4',15);
        ...
        <div class="row align-items-center">
          <div class="col-xxl-6 col-md-9 col-xl-6 col-lg-6 offset-xxl-1 order-lg-2 mb-mobile-lg">
            <div class="video-block" data-aos="fade-left" data-aos-duration="800">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/career/video.png" alt="content-image" class="w-100">
              <div class="dots">
            ...
            <div class="service-section-03__sidebar">
              <h6 class="title"><?= $section_4['text'] ?></h6>
                ...
                <ul class="p-0 m-0 service-section-03__sidebar--list">
                  <li><a href="<?php echo esc_url( home_url( '/career' ) ); ?>">All Departments</a></li>

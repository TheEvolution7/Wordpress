...
$blog = new WP_Query(array('post_type'=>'post','post_status'=>'publish','cat' => 3,'posts_per_page' => 6,'category__not_in' => 9,'paged' => $current_page,'order' => 'DESC'));
?>
 ...
 <div class="breadcrumb-section">
      ...
      <div class="breadcrumb-section__bg-shape">
        <img src="<?= $section_1['banner'] ?>" alt="<?= the_title(); ?>">
      </div>
      <div class="container">
